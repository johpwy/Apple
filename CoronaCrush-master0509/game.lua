...
function create( )
	...
	tmp.x = centerX
	tmp.y = 37
	tmp:setFillColor( 175/255, 238/255, 238/255 )
	tmp.strokeWidth = 5
	tmp:setStrokeColor( 70/255, 130/255, 180/255 )
	...
	local tmp = display.newRoundedRect( layers.interface, 0, 0, 150, 30, 6 )
	tmp.x = 90
	tmp.y = h - 30
	tmp:setFillColor( 175/255, 238/255, 238/255 )
	tmp.strokeWidth = 2
	...
	local time = display.newText("02:00",100,34,gameFont,40 )
	time:setFillColor(178/255, 34/255, 34/255)
	time.x = 90
	time.y = h - 30
...
achievementPopup = function()
	...
	back.strokeWidth = 3
	back:setFillColor( 70/255, 130/255, 180/255 )
